...
function CreateSheetModal({
    ...
    const selectedClassName = classes.find((c) => c._id === selectedClass)?.name || "Chọn lớp";
...
function GradeStudentsModal({
    ...
    onSave: (grades: { studentId: string; score: number; feedback?: string }[]) => void;
    isLoading: boolean;
}) {
                    ...
                    renderItem={({ item }) => (
                        <View style={styles.studentGradeCard}>
                            <View style={styles.studentInfo}>
                                <LinearGradient
                                    colors={item.graded ? ["#10B981", "#059669"] : ["#9CA3AF", "#6B7280"]}
                            ...
                            <View style={styles.gradeInputRow}>
                                <View style={styles.scoreInputContainer}>
                                    ...
                                    <TextInput
                                        ...
                                        placeholderTextColor="#9CA3AF"
                                    />
                                    <Text style={styles.maxScoreText}>/{sheetData.gradingSheet.maxScore}</Text>
                                </View>
...
export default function TeacherGradingScreen() {
    ...
    const [selectedSheet, setSelectedSheet] = useState<GradingSheetWithStudents | null>(null);
    ...
    const handleSaveGrades = async (
        ...
        try {
            setIsSubmitting(true);
            await gradingService.bulkGradeStudents(selectedSheet.gradingSheet._id, { grades });
                            ...
                            >
                                ...
                                <View style={styles.sheetInfo}>
                                    ...
                                    <View style={styles.sheetMeta}>
                                        ...
                                        <Text style={styles.sheetDate}>{formatDate(sheet.createdAt)}</Text>
                                    </View>
                                </View>
