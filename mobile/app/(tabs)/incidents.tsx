    ...
    >
      <View style={styles.cardHeader}>
        <View style={styles.cardTitleRow}>
          <View style={[styles.typeIcon, { backgroundColor: statusColors.bg }]}>
            <Ionicons
      ...
      {incident.adminNote && (
        <View style={styles.adminNoteSection}>
          ...
          <Text style={styles.adminNoteText} numberOfLines={1}>
      ...
      <View style={styles.cardFooter}>
        <View style={styles.platformBadge}>
          <Ionicons
            name={incident.platform === "mobile" ? "phone-portrait" : "desktop"}
            size={12}
            color="#6B7280"
          />
...
export default function IncidentsScreen() {
  ...
  const filters = [
    ...
    { key: "resolved" as const, label: "Đã giải quyết", count: stats.resolved },
  ];
    ...
    <SafeAreaView style={styles.container} edges={["left", "right"]}>
      ...
      >
        ...
        >
          <View style={styles.summaryContent}>
            <View style={styles.summaryMain}>
              <Text style={styles.summaryLabel}>Báo cáo sự cố</Text>
              <Text style={styles.summaryTitle}>
                {stats.pending > 0
